    ...
    return (
        <Suspense fallback={<div>Loading...</div>}>
            ...
            {state === ActivateState.InsertNit ?
                ...
                />
                : null}
            {state === ActivateState.ConfirmPhone ?
                <ConfirmPhone
                    onBack={() => setState(ActivateState.InsertNit)}
            ...
            {state === ActivateState.WritePin ?
                <WritePin
                    onBack={() => setState(ActivateState.ConfirmPhone)}
                    onNext={() => handleVerify()}
                    error={error}
                    phone={phone}
                    token={token}
            ...
            {state === ActivateState.ModifyAddress ?
                ...
                />
                : null}
            {state === ActivateState.Congrats ?
                <Congrats
                    onBack={() => goToProducts()}
                    onNext={() => goToMyAccount()}
                    error={error}
                />
                : null}
        </Suspense>
