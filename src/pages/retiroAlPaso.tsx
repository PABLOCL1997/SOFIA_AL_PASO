...
import {
  ...
  StepMobileWrap,
  MobileStep
} from "../styled-components/RetiroAlPasoStyle";
        ...
        <StepsWrap>
          <Step>
            ...
            <Columns align={"left"}>
              <Image
                src={Image1}
                alt="[Retira al paso - Recibe en casa]"
                maxWidth={"236px"}
              />
            </Columns>
          </Step>
          <Step>
            ...
            <Columns align={"left"}>
              <TextContainer align={"left"}>
                <Text maxWidth={"315px"}>
                  Elige la sucursal de Sofía al Paso de tu preferencia
                </Text>
          ...
          <Step className="step-5">
            <Columns align={"right"}>
              <TextContainer align={"right"}>
                ...
                <SubText>Recibirás en los próximos minutos un email confirmando tu pedido y cuando tu pedido esté listo para retirar recibirás otro email para que pases por la sucursal de Sofía al Paso seleccionada.</SubText>
              </TextContainer>
            </Columns>
            <NumberIcon>
              <span>5</span>
        ...
        <StepMobileWrap>
          ...
          <MobileStep>
            ...
            <TextContainer>
              ...
              <SubText marginTop={"0px"}>Recibirás en los próximos minutos un email confirmando tu pedido y cuando tu pedido esté listo para retirar recibirás otro email para que pases por la sucursal de Sofía al Paso seleccionada.</SubText>
            </TextContainer>
