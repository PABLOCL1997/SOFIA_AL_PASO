            ...
            <GSC.Square>
                ...
                <SC.Actions.Wrapper>
                    <SC.Actions.Action>
                        ...
                        <SC.Actions.Icon.Wrapper>
                            ...
                            <SC.Actions.Label.Wrapper>
                                <SC.Actions.Label.Label>
                                {t("buy.icon_text")}
                                </SC.Actions.Label.Label>
                            </SC.Actions.Label.Wrapper>
                        </SC.Actions.Icon.Wrapper>
                        <SC.Actions.Button.Wrapper>
                            <GSC.ButtonPrimary onClick={() => onBack()}>
                                {t("buy.call_to_action")}
                            </GSC.ButtonPrimary>
                        </SC.Actions.Button.Wrapper>
                    ...
                    <SC.Actions.Action>
                        ...
                        <SC.Actions.Button.Wrapper>
                            <GSC.ButtonPrimary onClick={() => onNext()}>
                                {t("account.call_to_action")}
                            </GSC.ButtonPrimary>
                        </SC.Actions.Button.Wrapper>
...
const Account = () => {
    return (
        ...
        <path d="M63.0605 58.364C66.9098 58.364 70.0302 55.2435 70.0302 51.3943C70.0302 47.545 66.9098 44.4246 63.0605 44.4246C59.2113 44.4246 56.0908 47.545 56.0908 51.3943C56.0908 55.2435 59.2113 58.364 63.0605 58.364Z" fill="#FFF0F1" stroke="#E30613" stroke-width="2.6" stroke-miterlimit="10"/>
        <path d="M52.4956 64.4613C53.5667 62.6073 55.1069 61.0678 56.9613 59.9975C58.8158 58.9272 60.9192 58.3638 63.0604 58.3638C65.2015 58.3639 67.305 58.9273 69.1594 59.9977C71.0139 61.068 72.554 62.6075 73.6251 64.4615" stroke="#E30613" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}