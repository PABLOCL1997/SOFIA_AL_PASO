...
const ModifyAddress: FC<ActivateProps & Props> = ({ onBack, onNext, street, setStreet, phone, setPhone, city, latitude, setLatitude, longitude, setLongitude }) => {
  ...
  return (
    <GSC.Wrapper>
      ...
      <GSC.Square>
        ...
        <SC.CallToAction>
          <GSC.ButtonPrimary onClick={() => handleNext()}>{t("next")}</GSC.ButtonPrimary>
        </SC.CallToAction>
      </GSC.Square>
    </GSC.Wrapper>
  );
...
const Pin = () => {
  return (
    <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M7.04917 0C3.12177 0 0 3.09525 0 6.98927C0 8.88636 0.704917 10.6836 2.11475 11.9816C2.21545 12.0814 6.24355 15.6759 6.34425 15.7758C6.74706 16.0753 7.35127 16.0753 7.65338 15.7758C7.75408 15.6759 11.8829 12.0814 11.8829 11.9816C13.2927 10.6836 13.9976 8.88636 13.9976 6.98927C14.0983 3.09525 10.9766 0 7.04917 0ZM7.04917 8.9862C5.94144 8.9862 5.03512 8.08758 5.03512 6.98927C5.03512 5.89095 5.94144 4.99233 7.04917 4.99233C8.15689 4.99233 9.06321 5.89095 9.06321 6.98927C9.06321 8.08758 8.15689 8.9862 7.04917 8.9862Z"
        fill="#E30613"
      />
    </svg>
  );
