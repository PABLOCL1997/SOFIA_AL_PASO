    ...
    <Wrapper>
      ...
      <MenuList>
        ...
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={keepQueryParameter("/")}>
            {t("header.home")}
          </Link>
        </MenuItem>
        <MenuItem>
        ...
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={keepQueryParameter("/preguntas-frecuentes")}>
            {t("header.faq")}
          </Link>
        </MenuItem>
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={keepQueryParameter("/segui-tu-pedido")}>
            {t("header.tracking")}
          </Link>
        </MenuItem>
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={keepQueryParameter("/contacto")}>
            {t("header.contact")}
          </Link>
        </MenuItem>
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={keepQueryParameter("/cobertura")}>
            {t("header.coverage")}
          </Link>
        </MenuItem>
        <MenuItem>
                  ...
                  <Category isVisible={showCategories} showSubCategories={category.entity_id === categoryOpen}>
                    ...
                    >
                      <Link
                        ...
                        to={keepQueryParameter(`/productos/${toLink(category.name)}`)}
                      >
                        {category.name}
                      </Link>
                        ...
                        category.subcategories.map((subcategory: SubCategoryLvl3Type) => (
                          <Subcategory>
                            <Link
                              ...
                              to={keepQueryParameter(`/productos/${toLink(category.name)}/${toLink(subcategory.name)}`)}
                            >
                              {subcategory.name}
                            </Link>
                          </Subcategory>
