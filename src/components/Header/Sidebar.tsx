    ...
    <Wrapper>
      ...
      <MenuList>
        ...
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={`/preguntas-frecuentes${search}`}>
            {t("header.faq")}
          </Link>
        </MenuItem>
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={`/segui-tu-pedido${search}`}>
            {t("header.tracking")}
          </Link>
        </MenuItem>
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={`/contacto${search}`}>
            {t("header.contact")}
          </Link>
        </MenuItem>
        <MenuItem>
          ...
          <Link onClick={() => setOpen(false)} to={`/cobertura${search}`}>
            {t("header.coverage")}
          </Link>
        </MenuItem>
        <MenuItem>
                  ...
                  <Category isVisible={showCategories} showSubCategories={category.entity_id === categoryOpen}>
                    ...
                    >
                      <Link
                        ...
                        to={`/productos/${toLink(category.name)}${search}`}
                      >
                        {category.name}
                      </Link>
                        ...
                        category.subcategories.map((subcategory: SubCategoryLvl3Type) => (
                          <Subcategory>
                            <Link
                              ...
                              to={`/productos/${toLink(category.name)}/${toLink(subcategory.name)}${search}`}
                            >
                              {subcategory.name}
                            </Link>
                          </Subcategory>
