...
const EmployeeModal: FC<Props> = ({ show, setShowOpen, setCuentaActiva, userData, userDetails }) => {
  ...
  const handleChange = (evt: { target: { validity: { valid: any }; value: any } }) => {
    const ClientGoal = evt.target.validity.valid ? evt.target.value : clientCode;
      ...
      <ModalCourtain className={show ? "visible" : ""}>
        <Modal padding={"36px 42px 20px"}>
          ...
          {steps === Steps.AskNit && knowCode ? (
            <Fragment>
              <Title marginBottom={"30px"}>{t("employeeModal.activar_cuenta")}</Title>

              <InputLabel show={clientCode !== ""}>{t("employeeModal.carnet_de_identidad")}</InputLabel>
              ...
              <input
                ...
                autoComplete="off"
                className={clientCode !== "" && clientCode.length <= 3 ? "error" : ""}
              />
          ...
          {steps === Steps.AskNit && !knowCode ? (
            <Fragment>
              <Title marginBottom={"30px"}>{t("auth_modal.activate_account.title")}</Title>

              <SmallText>{t("auth_modal.activate_account.know_code_text")}</SmallText>
              <SmallText marginBottom={"30px"}>{t("auth_modal.activate_account.know_code_text2")}</SmallText>
          ...
          {steps === Steps.AskPin ? (
            <Fragment>
              ...
              <SmallText>
                ...
                {clientPhone ? (
                  <>
                    ...
                    {clientPhone
                      .split("")
                      .map((c: String, index: number, arr: any[]) => (arr.length > 5 && index >= 3 && index <= 5 ? "*" : c))
                      .join("")}
                  </>
                ) : null}
              </SmallText>
              ...
              <Counter>
                <h4>
                  00:
                  {counter < 10 ? <span>0{counter}</span> : <span>{counter}</span>}
                </h4>
              </Counter>
              ...
              <FourCodeInputs>
                {pin2 === "" && pin1 !== "" ? (
                  <>
                    <InputCode {...pinConfig} name="first" onChange={handleChangePin1} value={pin1} autoFocus className={pin1 !== "" ? "filled" : ""} />
                  </>
                ) : (
                  <InputCode {...pinConfig} name="first" onChange={handleChangePin1} value={pin1} className={pin1 !== "" ? "filled" : ""} />
                )}

                {pin1 !== "" && pin3 === "" ? (
                  <>
                    <InputCode {...pinConfig} name="second" onChange={handleChangePin2} value={pin2} autoFocus className={pin2 !== "" ? "filled" : ""} />
                  </>
                ) : (
                  <InputCode {...pinConfig} name="second" onChange={handleChangePin2} value={pin2} className={pin2 !== "" ? "filled" : ""} />
                )}

                {pin1 !== "" && pin2 !== "" && pin4 === "" ? (
                  <>
                    <InputCode {...pinConfig} name="third" onChange={handleChangePin3} value={pin3} className={pin3 !== "" ? "filled" : ""} autoFocus />
                  </>
                ) : (
                  <InputCode {...pinConfig} name="third" onChange={handleChangePin3} className={pin3 !== "" ? "filled" : ""} value={pin3} />
                )}

                {pin1 !== "" && pin2 !== "" && pin3 !== "" && pin5 === "" ? (
                  <>
                    <InputCode {...pinConfig} name="four" onChange={handleChangePin4} value={pin4} className={pin4 !== "" ? "filled" : ""} autoFocus />
                  </>
                ) : (
                  <InputCode {...pinConfig} name="four" onChange={handleChangePin4} className={pin4 !== "" ? "filled" : ""} value={pin4} />
                )}

                {pin1 !== "" && pin2 !== "" && pin3 !== "" && pin4 !== "" && pin6 === "" ? (
                  <>
                    <InputCode {...pinConfig} name="five" onChange={handleChangePin5} value={pin5} className={pin5 !== "" ? "filled" : ""} autoFocus />
                  </>
                ) : (
                  <InputCode {...pinConfig} name="five" onChange={handleChangePin5} className={pin5 !== "" ? "filled" : ""} value={pin5} />
                )}

                {pin1 !== "" && pin2 !== "" && pin3 !== "" && pin4 !== "" && pin5 !== "" ? (
                  <>
                    <InputCode {...pinConfig} name="six" onChange={handleChangePin6} value={pin6} className={pin6 !== "" ? "filled" : ""} autoFocus />
                  </>
                ) : (
                  <InputCode {...pinConfig} name="six" onChange={handleChangePin6} className={pin6 !== "" ? "filled" : ""} value={pin6} />
                )}
              </FourCodeInputs>
              ...
              <Disclaimer>
                ...
                <Anchor href="mailto:etoledo@avicolasofia.com">Ayuda</Anchor>
              </Disclaimer>
            </Fragment>
          ) : null}
          ...
          {steps === Steps.AccountActivated ? (
            <Fragment>
              ...
              <Title marginBottom={"30px"}>{t("employeeModal.cuenta_activada")}</Title>

              <SmallText>{t("employeeModal.cuenta_activada_subtitulo")}</SmallText>
