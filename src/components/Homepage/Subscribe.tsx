      ...
      <Wrapper>
        ...
        <IconWrapper>
          <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              d="M11 32C12.6569 32 14 30.6569 14 29C14 27.3431 12.6569 26 11 26C9.34315 26 8 27.3431 8 29C8 30.6569 9.34315 32 11 32Z"
              stroke="#E30613"
              strokeWidth="3"
              strokeMiterlimit="10"
              strokeLinecap="round"
            ...
            />
            <path
              d="M27 32C28.6569 32 30 30.6569 30 29C30 27.3431 28.6569 26 27 26C25.3431 26 24 27.3431 24 29C24 30.6569 25.3431 32 27 32Z"
              stroke="#E30613"
              strokeWidth="3"
              strokeMiterlimit="10"
              strokeLinecap="round"
