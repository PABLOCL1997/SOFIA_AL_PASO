...
const DeliveryBag = React.lazy(() => import(/* webpackChunkName: "DeliveryBag" */'../Images/DeliveryBag'));
const FreeShipping = React.lazy(() => import(/* webpackChunkName: "FreeShipping" */'../Images/FreeShipping'));
const Wallet = React.lazy(() => import(/* webpackChunkName: "Wallet" */'../Images/Wallet'));
