...
const Clip = styled.div`
    ...
    clip-path: path('M99.8061 345.582C229.433 114.928 653.103 177.767 479.24 82.4497C305.376 -12.8674 364.283 105.9 100.206 18.53C-163.871 -68.8401 -254.181 192.125 -185.723 252.594C-103.68 325.113 77.913 213.982 99.8061 345.582Z');
    border-bottom-left-radius: 16px;
    border-bottom-right-radius: 16px;
    
    @media screen and (max-width: ${BREAKPOINT}) {
        height: 100%;
        clip-path: path('M94.2049 474.47C206.234 275.128 572.39 329.437 422.129 247.059C271.868 164.682 276.015 286.47 86.4037 191.8C-103.208 97.1294 -170.534 343.694 -152.563 394.106C-81.6576 456.78 75.2839 360.735 94.2049 474.47Z');
    }
